...
locals {
  ...
  stage_lambdas = {
    ...
    planner      = "src.lambdas.planner_handler.handler"
    coder        = "src.lambdas.coder_handler.handler"
    reviewer     = "src.lambdas.reviewer_handler.handler"
    sandbox      = "src.lambdas.sandbox_handler.handler"
